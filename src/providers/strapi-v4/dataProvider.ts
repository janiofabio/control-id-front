...
export const DataProvider = (
  ...
  getList: async ({ resource, pagination, filters, sorters, meta }) => {
    ...
    return {
      ...
      total: data.meta?.total || normalizeData(data)?.meta?.total,
    };
  },
  ...
  //  :{url: string, method: "get" | "delete" | "head" | "options" | "post" | "put" | "patch", filters: CrudFilter[] | undefined, sorters: CrudSorting | undefined, payload: TPayload | undefined, query: TQuery | headers: {} | undefined | any  }
