...
// Criando o contexto para o formulário de documentos
...
const DocumentForm = ({
    ...
    const onSubmit = (data: Document) => {
        ...
        if (selectedFile) {
            data.fileUrl = URL.createObjectURL(selectedFile);
    ...
    useEffect(() => {
        if (editIndex !== null) {
            ...
            setSelectedFile(doc.fileUrl ? new File([], doc.fileName || "") : null);
            console.log("Editing document at index:", editIndex, doc);
        }
            ...
            <FormProvider {...methods}>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <DialogActions>
                        ...
                        <Button type="submit">{editIndex !== null ? "Salvar Alterações" : "Adicionar"}</Button>
                    </DialogActions>
                </form>
            </FormProvider>
        </Dialog>
