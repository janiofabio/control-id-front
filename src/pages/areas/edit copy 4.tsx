...
import { useTranslate, useUpdate, useNotification, useNavigation, useShow } from "@refinedev/core";
...
export const AreaEdit: React.FC = () => {
  ...
  const { control, handleSubmit, watch, setValue } = useForm({
    defaultValues: {
      ...
      historico: areaData?.data.historico || [],
    },
  });
  ...
  const onSubmit = async (dados: any) => {
    try {
      ...
      const novoHistorico = addHistoryEntry(dados.historico, 'edição', 'área');
