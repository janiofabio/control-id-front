...
export const PersonCreate = () => {
    ...
    const [documents, setDocuments] = useState([]); // Hold documents here
    ...
    // Upload document files to Strapi
    const uploadDocumentsToStrapi = async () => {
    ...
    const onSubmit = async (data: any) => {
        try {
            ...
            const uploadedDocs = await uploadDocumentsToStrapi();
            data.documents = uploadedDocs; // Append uploaded documents to form data
                ...
                <Box sx={{ padding: 2 }}>
                    ...
                    <Box sx={{ mt: 2 }}>
                        ...
                        <TabPanel value={tabValue} index={2}>
                             <DocumentSection setDocuments={setDocuments} />
                        </TabPanel>
